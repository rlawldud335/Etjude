...
export default {
  ...
  setup() {
      ...
      script: [
        {
          roleId: 1,
          rolePhotoUrl:
            "https://w.namu.la/s/4e3a6f95f0790418d5a7fed457a680dd753b494e747e8fc4be49394758d84fd09578ae4e53cf9c39648eec45bbb61951168371d5d01af4b11347b65b8174cbf40c3be2738d6f157ee611d238cd0b3f0a08ca3050f7f873bb9507121469edcbc7",
          roleName: "손석구",
          sceneId: 1,
          sceneNumber: 1,
          sceneFileName:
    ...
    const allScripts = [];
    let index = 0;
    studioData.script.forEach((scene) => {
