...
<template class="event-banner">
    <Carousel ref="event-carousel" v-model="currentSlide" :items-to-show="1.6" :wrap-around="true" :autoplay="20000" class="event-carousel" >
    ...
    <div class="event-navigation">
        <div class="event-navigation--center">
            ...
            <div class="event-navigation__tags" ref="eventTags">
                <div v-for="(event, index) in eventList" :key="index" class="event-navigation__tags__tag" @click="sildeTo(index)">{{ event.eventName }}</div>
            </div>
  ...
  export default {
    ...
    return {
      eventList :[
        {url:'',image:"Main Banner01.png",eventName:"이벤트1"},
